...
import Reactlogo from '../assets/images/edu.svg'
...
const Homecard = () => {
  return (
    ...
    <section
        class="flex flex-wrap items-center -mx-3 font-sans px-4 mx-auto w-full lg:max-w-screen-lg sm:max-w-screen-sm md:max-w-screen-md pb-20 z-index-100">
       
        <div class="px-3 mb-4 w-full lg:w-2/5">
            <div
            ...
            <div class="text-center lg:text-left">
                <a href="/student-register"
                    class="block visible py-4 px-8 mb-4 text-xs font-semibold tracking-wide leading-none text-white bg-blue-500 rounded cursor-pointer sm:mr-3 sm:mb-0 sm:inline-block"
                      ...
                      <a href="/teacher-register" class="block visible  mb-4 py-4 px-8 text-xs font-semibold leading-none bg-white rounded border border-solid cursor-pointer sm:inline-block border-slate-200 text-slate-500">Login For Teachers</a>
                <a href="/university-register" class="block visible py-4 px-8 text-xs font-semibold leading-none bg-white rounded border border-solid cursor-pointer sm:inline-block border-slate-200 text-slate-500">Login For University</a>
